...
export default function Other({ currentUser, sendRSVP }) {
  ...
  //     const res = await fetch("http://localhost:3001/api/rsvp");
    ...
    return (
      <div className="rsvp-q">
        ...
        <div className="inputs">
          ...
          <button className={rsvpReply.saturday === "yes" ? "btn-clicked" : "rsvp-btn"} onClick={setRsvpReply(prevState => ({ ...prevState, saturday: "yes" }))}>Yes</button>
          {/* <button className={clickSaturday.no ? "btn-clicked" : "rsvp-btn"} onClick={noSaturday}>No</button> */}
          <button className={rsvpReply.saturday === "no" ? "btn-clicked" : "rsvp-btn"} onClick={noSaturday}>No</button>
          {/* <button className={clickSaturday.maybe ? "btn-clicked" : "rsvp-btn"} onClick={maybeSaturday}>Maybe</button> */}
          <button className={rsvpReply.saturday === "maybe" ? "btn-clicked" : "rsvp-btn"} onClick={maybeSaturday}>Maybe</button>
      ...
      <div className="rsvp-container">
        ...
        <form className="rsvp-form">
          <div className="rsvp-content">
            ...
            {rsvpReply.saturday === "no" || clickSaturdayChildren.yes || clickSaturdayChildren.no || clickSaturdayChildren.maybe ? sunday() : <></>}

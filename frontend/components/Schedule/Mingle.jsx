  ...
  return (
    <div className="modal-bg" onClick={close}>
      <div className="schedule-modal" id="saturday-mingle-modal">
        ...
        <img src="https://firebasestorage.googleapis.com/v0/b/gallery-23854.appspot.com/o/039-1.jpeg?alt=media&token=7ef049c5-3bbb-4b7e-95d7-3fc062bc6896" alt="saturday-mingle" id="mingle"/>

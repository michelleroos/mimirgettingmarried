  ...
  return (
    <div className="modal-bg" onClick={close}>
      <div className="schedule-modal" id="friday-modal">
        ...
        <img src="https://1.bp.blogspot.com/-3_5l3viHVJc/YKPiTYMTe9I/AAAAAAAAFN0/FCezW2Nt5_wBPt5h-hoalGgaLGSN4V9OACLcBGAsYHQ/s1422/Czech1-min.png" alt="beer-prague" id="friday" />

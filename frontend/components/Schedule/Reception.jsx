  ...
  return (
    <div className="modal-bg" onClick={close}>
      <div className="schedule-modal">
        ...
        <h2>Reception</h2>
        <h3>The Villa features restaurant Piano Nobile which has a  terrace overlooking the vineyard. The  menu at Piano Nobile is inspired by Czech and European cousine and uses seasonal and local ingredients.</h3>
        <img src="https://firebasestorage.googleapis.com/v0/b/gallery-23854.appspot.com/o/dekor-villa-richter-18-1400x933.jpeg?alt=media&token=56cc93b2-91a4-4ccf-a748-7283aaa4f7a2" alt="saturday-reception" />

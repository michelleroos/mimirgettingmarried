  ...
  return (
    <div className="modal-bg" onClick={close}>
      <div className="schedule-modal" id="saturday-ceremony-modal">
        ...
        <img src="https://firebasestorage.googleapis.com/v0/b/gallery-23854.appspot.com/o/SabrinaJan-057-2-1400x1050.jpeg?alt=media&token=4e03503e-5c38-4e60-915a-6051e609e94e" alt="saturday-ceremony" id="ceremony"/>
